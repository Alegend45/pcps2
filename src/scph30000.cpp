...
u8 scph30000_ee_rb(void* dev, u32 addr)
{
...
u16 scph30000_ee_rh(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
u32 scph30000_ee_rw(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
u64 scph30000_ee_rd(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
u128 scph30000_ee_rq(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    u128 result;
    result.lo = 0;
...
void scph30000_ee_wb(void* dev, u32 addr, u8 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
void scph30000_ee_wh(void* dev, u32 addr, u16 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
void scph30000_ee_ww(void* dev, u32 addr, u32 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
void scph30000_ee_wd(void* dev, u32 addr, u64 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
    ...
    {
        if(addr < 0x10002000 || addr >= 0x10003000) scph30000_ee_ww(dev, addr, (u32)data);
...
void scph30000_ee_wq(void* dev, u32 addr, u128 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x10000000)
    {
...
u8 scph30000_iop_rb(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x00200000)
    {
...
u16 scph30000_iop_rh(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x00200000)
    {
...
u32 scph30000_iop_rw(void* dev, u32 addr)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x00200000)
    {
...
void scph30000_iop_wb(void* dev, u32 addr, u8 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x00200000)
    {
...
void scph30000_iop_wh(void* dev, u32 addr, u16 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x00200000)
    {
...
void scph30000_iop_ww(void* dev, u32 addr, u32 data)
{
    scph30000* device = (scph30000*) dev;
    if(addr < 0x00200000)
    {
